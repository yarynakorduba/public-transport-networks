...
const Subchapter_2_2 = () => (
  <section>
    ...
    <div className={b("illustration", ["sticky", "ref"])}>
      Про <a href={"https://en.wikipedia.org/wiki/Siemens_%26_Halske"}>Siemens & Halske</a>
    </div>
    <p className={b("paragraph")}>
    ...
    <div className={b("illustration", ["sticky", "ref"])}>
      ...
      >
        будівництво підземного трамваю
      </a>{" "}
    </div>
    <p className={b("paragraph")}>
    ...
    <div className={b("illustration", ["sticky", "ref"])}>
      <a href="https://www.city-adm.lviv.ua/lmr/images/stories/arhitect/123/01_genplan.pdf">Генплан міста</a>
    </div>
    <p className={b("paragraph")}>
    ...
    <div className={b("illustration", ["sticky", "ref"])}>
      ...
      <a href={"https://zaxid.net/lvivskiy_transport_zmina_radikalna_ruh__radialniy_n1232279"}>
        зміни у львівській транспортній системі
      </a>
    </div>
    <p className={b("paragraph")}>
    ...
    <div className={b("illustration", ["sticky"])} style={{ height: "65vh" }}>
      <RadialStops />
    </div>
