...
const Article = () => (
  <div className={b()}>
    ...
    <p className={b("paragraph", ["first"])}>
      ...
      . Білі вузли - кінцеві зупинки. Жовті - зупинки із більш, ніж п'ятьма з'єднаннями. (Задля покращення сприйняття
      інформації проміжні зупинки (зупинки із двома з'єднаннями) не відображаються.) Кількість зупинок в автобусній
      мережі Лондона більша за брістольську у більш, ніж 6 разів. Тому в L-space також набагато більше вузлів та ребер.
    </p>
