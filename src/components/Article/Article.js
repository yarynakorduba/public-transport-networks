...
const Article = () => (
  <div className={b()}>
    ...
    <p className={b("paragraph", ["first"])}>
      ...
      <Note noteText={"Автори: Головач, де Регт"}>
        <a href={"https://arxiv.org/pdf/1705.07266.pdf"}>"Public transportation in UK viewed as a complex network"</a>
      </Note>
      . Для отримання повної картини ми відтворили результати двох міст у <Latex>$L\text-space$</Latex> і порівняли їх
    ...
    <p className={b("paragraph")}>
      ...
      <Latex>$к$</Latex>. Цей критерій дозволяє визначити стійкість до рандомних атак і відображає наявність гігантської
    ...
    <p className={b("paragraph", ["first"])}>
      ...
      значення центральності вузлів (mean betweenness centrality) <Latex>$C_\beta=0.007$</Latex>. ..в той час як у
      лондонській мережі їх кількість - <span style={{ background: "orange", padding: "0.3rem" }}>?</span>
    </p>
