...
const Article = () => (
  <div className={"Article"}>
    ...
    <p className={"Article__paragraph Article__paragraph_first"}>
      ...
      <img className="Article__image Article__image_small" src={BristolCSpace} />
    </p>
    <p className={"Article__paragraph"}>
    ...
    <p className={"Article__paragraph"}>
      ...
      network resilience. Later, the representation in <Trigger data={{ space: "C" }}>C-space</Trigger> was generated to
      analyse the network from the routes perspective.
    </p>
    <p className={"Article__paragraph"}>
