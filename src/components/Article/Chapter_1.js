...
const Chapter_1 = () => (
  <section>
    ...
    <p className={b("paragraph", ["first"])}>
      Однією з ключових характеристик сучасного світу є зростання ролі міста. Якщо в 1960 році лише 34% людей проживали
      у містах, то зараз цей{" "}
      <a href={"https://data.worldbank.org/indicator/sp.urb.totl.in.zs?end=2017&start=1960&view=chart"}>показник</a>{" "}
      досягнув 55%. Який простір є комфортним для життя? Як стимулювати розвиток міського бізнесу, інфраструктури та
      культури? Обговорення цих питань привели до виникнення урбаністики. Урбаністика - наука, спрямована на вирішення
      потреб сучасного міста і створення комфортних умов для його розвитку. Урбаністика поєднує різні галузі знань:
      соціологію, антропологію, економіку, щоб зробити міську територію зручною для кожного жителя.
    </p>
    ...
    <p className={b("paragraph")}>
      Представники середнього класу почали переїжджати, покидаючи цілі квартали пустувати. Залишилися лише безробітні та
      робітники з низьким доходом. З’явилися кримінальні групи. В 70 роках через{" "}
      <a
        href={
