...
const Subchapter_2_2 = () => (
  <section>
    ...
    <p className={b("article")}>
      ...
      . Темнокоричневі вагони курсували двома маршрутами: від залізничного вокзалу до вул. Митної і від залізничного
      вокзалу до Підзамче.
    </p>
    <figure>
    ...
    <p className={b("article")}>
      ...
      основним транспортом міста. У 1928 році на вулицях з’явилися автобуси, а 1952 році - тролейбуси.
    </p>
    <p className={b("article")}>
    ...
    <figure>
      <img href="./img/chapter2/lvivMetro.png" alt={"Lviv Metro"} className={b("image")} />
    ...
    <p className={b("article")}>
      ...
      Свободи. Для поїздок між околицями запланували 40 хордових маршрутів. Із транспортної схеми зникли автобуси, що
      дублювали шляхи електротранспорту. На автобусах встановили GPS пристрої. В кінці 2012 запрацював Центр управління
      дорожнім рухом. Він контролює систему “розумних світлофорів” і відслідковує рух громадського транспорту. Почали
      з’являтися велодоріжки. У 2013 центр Львова став пішохідним. Трамвайна мережа також зазнала змін: у 2016 відкрили
      швидкісну лінію на Сихів.
    </p>
    <p className={b("article")}>
